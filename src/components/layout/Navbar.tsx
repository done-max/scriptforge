      ...
      <header className="relative z-30 h-16 border-b border-forge-cyan/15 bg-odyssey-abyss/90 backdrop-blur-xl px-4 lg:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-odyssey-depth/70 hover:bg-odyssey-trench border border-forge-cyan/30 text-paper-200 hover:text-paper-50 transition-all"
          >
            <Globe className="w-3.5 h-3.5 text-forge-sky" />
            <span className="hidden sm:inline">{isLandingPage ? 'Launch Studio →' : 'Public Website'}</span>
          </button>
